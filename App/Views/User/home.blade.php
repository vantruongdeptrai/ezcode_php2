            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_2">Courses</a>
                        </li>
                    ...
                    <div class="d-none d-lg-block me-5" >
                        <div class="dropdown">
                        <a href="#top" class="navbar-icon bi-person" id="dropdownMenuButton1" data-bs-toggle="dropdown"></a>
                        <ul class="dropdown-menu mt-3" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item bg-info text-bg-dark" aria-current="true" href="{{route('user/register')}}">Register / Sign-In</a></li>
                            <li><a class="dropdown-item" href="#">My Account</a></li>
                            <li><a class="dropdown-item bg-info text-bg-dark" href="#">Something</a></li>
                        </ul>
                        </div>
                    </div>
                </div>                
